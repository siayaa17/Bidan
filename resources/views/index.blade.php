...
<head>
  ...
  <title>Pages / Login - Aplikasi Bidan</title>
          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">KETIK EMAIL & PASSWORD</p>
                  </div>

                  <form class="row g-3" method="POST" action="/prosesLogin">
                   @csrf
                    <div class="col-12">
                    ...
                    <div class="g-recaptcha" data-sitekey="6Lcox0AoAAAAAGBb3UcS0GJIB7IVDjzH-HjFC_jH"></div>
                    <div class="col-12">
              ...
              <div class="credits">
                ...
                Designed by <a href="https://instagram.com/its.syairaaa?igshid=MzRlODBiNWFlZA==">syairaa</a>
              </div>
